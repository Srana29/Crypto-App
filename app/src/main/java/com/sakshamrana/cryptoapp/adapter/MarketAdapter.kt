package com.sakshamrana.cryptoapp.adapter
...
import com.sakshamrana.cryptoapp.databinding.CurrencyItemLayoutBinding
import com.sakshamrana.cryptoapp.fragment.HomeFragmentDirections
import com.sakshamrana.cryptoapp.fragment.MarketFragmentDirections
import com.sakshamrana.cryptoapp.fragment.WatchlistFragmentDirections
...
class MarketAdapter(var context: Context, var list: List<CryptoCurrency>, var type: String): RecyclerView.Adapter<MarketAdapter.MarketViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MarketViewHolder, position: Int) {
        ...
        holder.binding.currencySymbolTextView.text = item.symbol //symbol
